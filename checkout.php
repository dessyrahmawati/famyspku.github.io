...
<div class="section">
    ...
    <tr>
        <th class="empty" colspan="2"></th>
        <th>BIAYA TAMBAHAN BERAT</th>
        <th class="text-center">
            <?php
            // Hitung biaya tambahan berat barang
            $biaya_tambahan_berat = 0;
            if ($total_berat > 100) {
                $biaya_tambahan_berat = 5000;
                echo "Rp. " . number_format($biaya_tambahan_berat) . " ,-";
            } else {
                echo "Rp. 0 ,-";
            }
            ?>
    ...
    <tr>
        ...
        <th>TOTAL BAYAR</th>
        <th class="text-center">
            <span id="tampil_total">
                <?php 
                // Hitung total bayar termasuk biaya tambahan berat
                $total_bayar = $jumlah_total + $biaya_tambahan_berat;
                ...
                ?>
										...
										<input type="hidden" name="biaya_tambahan_berat" value="<?php echo $biaya_tambahan_berat; ?>">
